...
const projects = [
  {
    ...
    description: 'Full-stack async telemedicine platform where patients submit skin photos and a structured symptom intake form, and a certified Swiss dermatologist responds within 48 hours with a written assessment and recommendations. Built end-to-end: multi-role auth, Stripe payments with server-side verification, secure private file uploads, PDF export, email/WhatsApp notifications, and full internationalization in English, French, and German. Designed to serve patients across Switzerland, Germany, France, Canada, and more — compliant with Swiss medical law (MedBG) and GDPR.',
    technologies: [
      'Next.js 15',
      'TypeScript',
      'Supabase',
    ...
    features: [
      'Multi-role auth (patient, doctor, admin) with Google OAuth and email/password via Supabase Auth',
      'Stripe payments with server-side payment verification and price enforcement per consultation',
      'Structured symptom intake form with Zod validation and server actions',
      'Secure photo uploads (3–5 photos) to a private Supabase Storage bucket with signed-URL access',
      'Postgres Row Level Security enforcing per-patient data isolation on every table',
      'Doctor dashboard: case queue, written assessments, optional e-prescriptions, mark-complete',
      'Automated PDF export of consultations and invoices via pdf-lib',
      'Email (Resend) and WhatsApp (Twilio) notifications for patients and the doctor',
      'Full internationalization in English, French, and German with next-intl',
      'Swiss "apothecary" design system built on Tailwind CSS v4 + shadcn/ui with Framer Motion',
    ],
  },
  {
    title: 'BuildPro - AI Contractor Quoting Platform',
    company: 'Personal Project',
    duration: 'April 2026',
    type: 'Full-Stack SaaS',
    category: 'SaaS & AI',
    featured: true,
    live: 'https://buildpro-psi-seven.vercel.app/',
    color: 'from-violet-600/20 to-purple-600/10',
    accent: 'text-violet-400',
    accentBg: 'bg-violet-500/10 border-violet-500/20',
    accentLine: 'from-violet-500 via-purple-500 to-primary',
    description: 'AI-powered quoting platform built for Canadian solo contractors. Contractors describe a job by voice or text and receive three professional estimates (Basic / Standard / Premium) in under 30 seconds — with city-specific Canadian market rates, correct provincial tax, editable line items, email delivery, and a public client approval link.',
    technologies: ['Next.js 15', 'TypeScript', 'Supabase', 'Anthropic Claude API', 'Stripe', 'Tailwind CSS', 'Resend'],
    features: [
      'AI-generated three-tier quotes (Basic / Standard / Premium) from a voice or text job description',
      'City-specific Canadian labour rates for Vancouver, Toronto, Calgary, Edmonton, and Montreal',
      'Provincial tax auto-calculated per city (GST, HST, GST+QST)',
      'Editable line items with live total recalculation',
      'Public client approval link — clients approve online with no account required',
      'Email quote delivery via Resend with professional HTML template',
      'Stripe subscription billing with free tier (3 lifetime quotes) and Pro plan ($49 CAD/mo)',
      'Company logo upload, custom terms, and branded quote documents',
      'Job templates, client address book with autocomplete, and quote history dashboard',
    ],
  },
  {
